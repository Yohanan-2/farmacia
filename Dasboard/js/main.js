const operacionModal = document.querySelector('.boton');
const modal = document.querySelector('.moda');
const operacionclose = document.querySelector('.delete');
operacionModal.addEventListener('click', (e)=>{
    e.preventDefault();
    modal.classList.add('modal--show');
});
operacionclose.addEventListener('click', (e)=>{
    e.preventDefault();
